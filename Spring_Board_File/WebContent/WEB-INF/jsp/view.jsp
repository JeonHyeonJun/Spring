...
<body>
	<center>
		...
		<table border="1" width="1000px" height="500px">
			<tr height="30px"><td width="100px" style= "background-color: yellow"><a href="download.do?num=${board.num }">${board.fileuri }</a></td><td align="right" colspan="3" style= "background-color: yellow">조회수 : ${board.readcount }</td></tr>
